...
// I only made this to work for Liars Dice, so it looks for images in emotes folder, you'll have to edit it if you want
// it to show images outside emotes folder, I personally cannot be bothered with that right now :P
